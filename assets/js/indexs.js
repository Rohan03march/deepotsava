...
import { getFirestore, setDoc, doc, getDoc, onSnapshot } from "https://www.gstatic.com/firebasejs/10.13.0/firebase-firestore.js";
...
const fetchUserPoints = async (userId) => {
    ...
    if (userDoc.exists()) {
        ...
        await setDoc(userRef, { totalPoints: totalPoints }, { merge: true });
...
// Function to update button href from Firestore
